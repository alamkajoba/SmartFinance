                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Modifier la catégorie</h3>
                            <div class="nk-block-des text-soft">
                                <p>Changez le nom de la catégorie ou adaptez-la à votre organisation.</p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input wire:model.defer="nomCategorie" type="text" id="nomCategorie" class="form-control" placeholder="Ex. Transport">
                                            </div>
